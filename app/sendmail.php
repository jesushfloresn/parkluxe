<?php
	...
	$cabeceras = "From: $email\n" //La persona que envia el correo
 		. "Reply-To: $email\n";
	$asunto = "Mensaje desde la pagina Web 'Park Luxe'"; //asunto aparecera en la bandeja del servidor de correo
	$email_to = "contacto@parkluxe.com.mx"; //cambiar por tu email
	$contenido = "$nombre ha enviado un mensaje desde la página web -Park Luxe-\n"
	. "\n"
	. "Nombre: $nombre\n"
	. "Teléfono: $telefono\n"
	. "Email: $email\n"
